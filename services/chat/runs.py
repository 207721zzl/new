...
from services.chat.repositories import AgentRunRepository, ConversationRepository
...
from packages.platform.tasks import current_lease
...
async def execute_agent_run(
    ...
    try:
        ...
        if current_lease.get() is not None:
            raise
